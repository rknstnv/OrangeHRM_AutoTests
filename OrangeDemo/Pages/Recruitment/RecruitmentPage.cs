...
namespace OrangeDemo.Pages.Recruitment
{
    public class RecruitmentPage : WebPage
    {
        public RecruitmentPage(BaseDriver driver) : base("dashboard/index", driver) { }

        public void CreateCandidate(string firstName, string lastName, string Email, string middleName = null, string vacancy = null, string contactNumber = null, string keywords = null, string date = null, string notes = null)
        {
            OpenPage();
        ...
        public void CreateVacansy(string vacancyName, string jobTitle)
        {
            OpenPage();

            SelectMenu("Recruitment");

            SelectTopbarMenu("Vacancies");

            Press_Button("Add");

            Fill_FieldByLabel("Vacancy Name", vacancyName);

            Select_DropDownRecord("Job Title", jobTitle);
        }
    }
}