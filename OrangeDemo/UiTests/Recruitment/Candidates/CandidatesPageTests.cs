...
namespace OrangeDemo.UiTests.Recruitment.Candidates
{
    [Parallelizable]
    [TestFixture]
    [AllureNUnit]
    public class CandidatesPageTests : Support
    {
        ...
        {
            page.CreateCandidate(FirstName, LastName, Email, middleName:Utilities.GenerateLetter(5), vacancy:"Senior QA Lead", contactNumber:Utilities.GenerateNumbers(11), keywords:Utilities.GenerateLetter(5), date: "2025-18-02", notes:Utilities.GenerateLetter(10));
        ...
        public void Create_CandidateWithKeepData()
        {
            page.CreateCandidate(FirstName, LastName, Email);
        ...
        {
            page.CreateCandidate(" ", "Testasd", Email);
        ...
        {
            page.CreateCandidate("Testasd", "TestASD", " ");
        ...
        {
            page.CreateCandidate(Utilities.GenerateLetter(31), "Testasd", Email);
        ...
        {
            page.CreateCandidate("Testasd", Utilities.GenerateLetter(31), Email);
        ...
        {
            page.CreateCandidate("Testasd", "TestASD", Email, middleName: Utilities.GenerateLetter(31));
        ...
        {
            page.CreateCandidate("Testasd", "TestASD", Utilities.GenerateLetter(5));
        ...
        {
            page.CreateCandidate("Testasd", "TestASD", Email, contactNumber:Utilities.GenerateLetter(5));
        ...
        {
            page.CreateCandidate("Testasd", "TestASD", Email, date: Utilities.GenerateLetter(5), notes:Utilities.GenerateLetter(5));
